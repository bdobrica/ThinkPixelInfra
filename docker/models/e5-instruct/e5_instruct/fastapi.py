"""
FastAPI server module for Multi-Lingual E5 Large Instruct embedding model inference.

This module provides a REST API interface for the Multi-Lingual E5 Large Instruct embeddings,
