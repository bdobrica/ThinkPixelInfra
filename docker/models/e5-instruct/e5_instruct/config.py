"""
Configuration module for Multi-Lingual E5 Large Instruct embedding model server.
...
Environment Variables:
    ...
    MODEL_PATH (str): Path to the Multi-Lingual E5 Large Instruct embedding model
...
Example:
    ...
    >>> from e5_instruct.config import LOCAL, MODEL_DEVICE
...
MODEL_PATH: str = os.getenv("MODEL_PATH", "/app/multilingual-e5-large-instruct")
MODEL_DEVICE: str = os.getenv("MODEL_DEVICE", "cpu")
MODEL_ZMQ_CLIENT_ADDR: str = os.getenv("MODEL_ZMQ_CLIENT_ADDR", "ipc:///tmp/multilingual-e5-large-instruct.client")
MODEL_ZMQ_WORKER_ADDR: str = os.getenv("MODEL_ZMQ_WORKER_ADDR", "ipc:///tmp/multilingual-e5-large-instruct.worker")
