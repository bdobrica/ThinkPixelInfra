...
_INSTRUCTIONS = {
    ...
    "de": "Angenommen, eine Web-Suchanfrage, rufen Sie relevante Passagen ab, die die Anfrage beantworten",
    "es": "Dada una consulta de búsqueda web, recupere los pasajes relevantes que respondan a la consulta",
    "it": "Data una query di ricerca web, recupera i passaggi rilevanti che rispondono alla query",
    "ro": "Având o interogare de căutare web, recuperați pasajele relevante care răspund la interogare",
    "auto": "Given a web search query, retrieve relevant passages that answer the query",
}
...
def get_search_prefix(language: str = "auto") -> str:
    ...
    """
    return "Instruct: " + _INSTRUCTIONS.get(language, _INSTRUCTIONS["auto"]) + "\nQuery: "
