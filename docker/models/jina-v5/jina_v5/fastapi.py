"""
FastAPI server module for jina-embeddings-v5-text-small-retrieval model inference.

This module provides a REST API interface for the jina-embeddings-v5-text-small-retrieval model,
...
async def infer(request: InferenceRequest) -> InferenceResponse:
    ...
    3. Dense vector embedding generation using jina-embeddings-v5-text-small
...
def fastapi_server():
    """
    Start the FastAPI HTTP server for the jina-embeddings-v5-text-small embedding service.
